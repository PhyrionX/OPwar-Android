...
public class UnidadBasica extends Unidad {
    public UnidadBasica(int id_unidad, String nombre, int movimientos, int habilidadArmas, int habilidadProyectiles, int fuerza, int resistencia, int heridas, int iniciativa, int ataques, int liderazgo, int puntos, int tamanyoMinimo) {
