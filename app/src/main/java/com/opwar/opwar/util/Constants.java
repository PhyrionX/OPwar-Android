...
public class Constants {
    private static final String HOST = "https://opwar.herokuapp.com/api";
    public static final String URL_GET_EJERCITOS = HOST + "/getEjercitos";
    public static final String URL_GET_UNIDADES = HOST +"/getUnidades/";
    public static final String LISTA_EJERCITO = "lista_ejercito";
